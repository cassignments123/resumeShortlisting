...
--
-- Host: localhost:3307
-- Generation Time: Mar 30, 2022 at 10:10 PM
...
(7, 10, 'Google', 'Cloud', 2, 'BE', 'Ahmedabad', 'www.Google/7/10'),
(8, 6, 'TCS', 'Java,Android', 5, 'M.Tech', 'Mumbai', 'www.TCS/8/6'),
(9, 11, 'Amazon', 'Flask,AWS,JS,', 2, 'B.Tech', 'Ahmedabad', 'www.Amazon/9/11'),
(10, 1, 'wipro', 'JS,Flask,', 1, 'BE', 'Ahmedabad', 'www.wipro/10/1');
...
(4, 0, 1, 'Kumar Jignesh', '1998-06-09', 'ashishmakhija2000@gmail.com', 2147483647, '05 Karnavati Flats,Saradarnagar', 'Java Associate', 'Java,Kotlin,Hibernate,', 'Ak Global', 'java Associate', '2022-02-10', '2022-03-02', 'I have worked as a Java Associate where I leaned more about java,crated Live project and got talk wi', 'Attendance Management', 'software that tracks the working hours of employees. It does precise time tracking for attendance, breaks, the time off taken, clock in and clock out,', 'Java,MongoDb', 'BE', 'English,French,');
